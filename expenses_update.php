...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  $sql = "SELECT * FROM expenses where user_id='$user_id' and e_id='$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE expenses SET amount='$amount', description='$description', category='$category', date='$date' WHERE user_id='$user_id' AND e_id='$id'";
